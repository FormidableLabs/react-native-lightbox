...
var LightboxOverlay = React.createClass({
  ...
  render: function() {
    var { isOpen, renderHeader, swipeToDismiss, backgroundColor } = this.props;
    var { isPanning, isAnimating, openVal, target, closeOrigin, isClosing } = this.state;
    var { origin } = this.props;
